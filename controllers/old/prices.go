...
// URLMapping ...
func (c *PricesController) URLMapping() {
...
// @Failure 403
// @router / [get]
func (c *PricesController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
func (c *PricesController) Delete() {
	...
	err = models.DeletePrices(id, trash)
