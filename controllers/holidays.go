...
// @router /:id [get]
func (c *HolidaysController) GetOne() {
	...
	v, err := models.GetHolidaysByID(id)
	if err != nil {
		c.ServeErrorJSON(err)
		return
	}
...
func (c *HolidaysController) GetAll() {
	...
	l, err := models.GetAllHolidays(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.ServeErrorJSON(err)
		return
	}
...
// Put ...
// @Title Put
// @Description update the Holidays
// @router /:id [put]
func (c *HolidaysController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, err := strconv.Atoi(idStr)
...
func (c *HolidaysController) Delete() {
	...
	err = models.DeleteHolidays(id, trash)
...
func (c *HolidaysController) GetAllFromTrash() {
	...
	v, err := models.GetHolidaysFromTrash()
